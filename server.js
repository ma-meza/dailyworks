...
mongoose.connect("mongodb+srv://markymark:Fortune2019@cluster0-sotud.gcp.mongodb.net/test?retryWrites=true&w=majority", {  useNewUrlParser: true}).catch(error => console.log("MONGO SERVER ERROR"+error));
// mongoose.connect('mongodb://localhost:27017/dailyworks', {useNewUrlParser: true}).catch(error => console.log("MONGO SERVER ERROR"+error));
// mongoose.connect('mongodb://localhost:27017/appointmentApp', {useNewUrlParser: true}).catch(error => console.log("MONGO SERVER ERROR"+error));
